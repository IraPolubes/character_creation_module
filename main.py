...
def attack(char_name: str, char_class: str) -> str:
    """Return evaluation of character attack outcome."""
    ...
    return (
        f'{char_name} неизвестного профиля'
    )


def defence(char_name: str, char_class: str) -> str:
    """Return evaluation of character self-defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return which special skill the character has used."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Train character to attack, defend, use special skill."""
    if char_class == 'warrior':
